...
var xScale = d3.time.scale()
				 .domain([
				 d3.min(dataset[0].Vsby, function(d) { return new Date(d[0] * 1000); }),
...
var rScale = d3.scale.linear()
				 .domain([d3.max(dataset[0].Vsby, function(d) { return d[1]; }),0])
				 .range([3, 8]);
...
var colors =['rgb(141,211,199)','rgb(255,255,179)','rgb(190,186,218)','rgb(251,128,114)'];
